...
[![R build status](https://github.com/tidyfun/tidyfun/workflows/R-CMD-check/badge.svg)](https://github.com/tidyfun/tidyfun/actions)
...
```{r, dti-ggplot-example, message=FALSE, warning = FALSE, eval = FALSE}
library("tidyfun")
...
[See here](https://tidyfun.github.io/tidyfun/articles/x02_Conversion.html) details on getting data into (and out of) the `tf` format.
