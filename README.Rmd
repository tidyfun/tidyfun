...
Look [here](https://tidyfun.github.io/tidyfun/articles/x01_Intro.html) for an introduction with examples.
...
in order to reshape tables with functional data, i.e., go from wide to narrow, or from long to short, and *vice versa*
 ([see here](https://tidyfun.github.io/tidyfun/articles/x02_Data_Manipulation.html)).
