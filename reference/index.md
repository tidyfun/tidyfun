...
- [`min(`*`<tf>`*`)`](https://tidyfun.github.io/tf/reference/tf_minmax.html)
  [`max(`*`<tf>`*`)`](https://tidyfun.github.io/tf/reference/tf_minmax.html)
  [`range(`*`<tf>`*`)`](https://tidyfun.github.io/tf/reference/tf_minmax.html)
  :

  Depth-based minimum, maximum and range for `tf` vectors (from tf)

- [`fivenum()`](https://tidyfun.github.io/tidyfun/reference/NA) :
