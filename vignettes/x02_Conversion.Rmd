...
```{r}
# split CCA profiles at the midpoint
cca_halves <- tf_split(cca_raw, splits = 0.5)

# result is a list of tf vectors, one per segment
str(cca_halves, max.level = 1)
