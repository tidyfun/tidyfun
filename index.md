# tidyfun [![tidyfun website](reference/figures/logo.gif)](https://tidyfun.github.io/tidyfun/)
...
![](reference/figures/README-dti-ggplot-example-1.png)
...
which lets you use standard **`ggplot2`** geoms (`geom_line`,
`geom_point`, `geom_ribbon`, …) with functional data via the `tf`
aesthetic. It also includes specialized **pasta-themed** geoms:
